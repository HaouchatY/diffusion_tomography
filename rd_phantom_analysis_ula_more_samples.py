...
def run_study(diag, phantom_indices):
    ...
    csv_dir = Path(f"metrics_csv_phantom_analysis_{diag}_rd_ula_more_samples")
        ...
        for procedure in procedures:
            ...
            for i in range(num_eval_samples):
                ...
                rows.append({
                    ...
                    "best_anis_param": float(anis_params[i]),
